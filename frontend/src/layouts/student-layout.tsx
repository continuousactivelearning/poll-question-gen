...
export default function StudentLayout() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-background/95 dark:from-background dark:via-background dark:to-background/95 dark:bg-black transition-colors">
      {/* <FloatingVideo isVisible={user?.role === 'student'}></FloatingVideo> */}

      {/* Ambient background effect */}
      <div className="fixed inset-0 bg-gradient-to-br from-primary/[0.02] via-transparent to-secondary/[0.02] pointer-events-none dark:from-primary/10 dark:to-secondary/10" />

      <header className="sticky top-0 z-50 flex h-16 shrink-0 items-center gap-2 border-b border-border/20 bg-white dark:bg-black backdrop-blur-xl supports-[backdrop-filter]:bg-white/90 dark:supports-[backdrop-filter]:bg-black/90 transition-all duration-300 before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-[#7b61ff]/10 before:to-transparent before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-500">
        <div className="flex w-full items-center justify-between px-8 relative z-10">
          <div className="relative z-20 flex items-center text-xl font-bold tracking-tight group cursor-pointer">
            <div className="flex items-center gap-3">
              <div className="h-12 w-12 rounded-lg overflow-hidden flex items-center justify-center bg-white dark:bg-black">
                <FaPoll className="h-10 w-10 text-[#7b61ff]" />
              </div>
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                {/* ThemeToggle button for dark/light mode */}
                <ThemeToggle />
              </div>
              ...
              <Link to="/student/profile" className="group relative">
                ...
                <Avatar className="relative h-9 w-9 cursor-pointer border-1 border-black transition-all duration-300 group-hover:border-primary/20 group-hover:shadow-xl group-hover:shadow-primary/20 group-hover:scale-105">
      ...
      <main className="relative flex flex-1 flex-col p-2">
        {/* Content background gradient */}
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-background/50 to-background pointer-events-none dark:via-background/80 dark:to-black" />
